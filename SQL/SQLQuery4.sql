...
values 
	...
	(2,'Priya',28,'India',15000),
	(3,'Amit',32,'India',15000),
	(4,'Neha',24,'India',15000),
	(5,'John',35,'USA',15000),
	(6,'Sarah',29,'UK',15000),
	(7,'David',41,'Canada',15000),
	(8,'Emma',27,'Australia',15000),
	(9,'Rohan',30,'India',15000),
	(10,'Sophia',33,'USA',15000)
;
...
--Task 17
select *
from customers order by amount_spend desc;
...
from customers where age BETWEEN 25 AND 40 AND amount_spend > 30000 and country In ('India','USA') order by amount_spend desc;

--Task 20
select *
from customers where age >=30 AND amount_spend > 30000 and country !='India' order by amount_spend desc;
